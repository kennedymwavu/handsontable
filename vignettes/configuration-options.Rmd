...
```{r basic-context}
handsontable(mtcars[1:6, 1:4], contextMenu = TRUE)
```
...
handsontable(csv_test_data, contextMenu = TRUE)
```
...
### Disabling Context Menu Options
```{r disable-csv-export}
custom_options <- list(
  "export_csv" = FALSE, # disable the CSV export
  "copy" = FALSE, # disable "Copy"
  "remove_row" = FALSE # disable "Remove Row"
)
